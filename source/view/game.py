...
class Game:
    ...
    def blit(self, game, window):
        ...
        for indices, item in enumerate(game.player):
            window.blit(self.get_image(item.name + '.png'), (const.DIMENSION_LABYRINTH + 20, indices * const.DIMENSION_SPRITE + 40))
    ...
    def get_image(self, name):
        ...
        image = pygame.transform.scale(background, (const.DIMENSION_SPRITE, const.DIMENSION_SPRITE))
        return image
